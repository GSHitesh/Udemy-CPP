...
WorkspacePath          :="H:/C++ Language/Section15"
ProjectPath            :="H:/C++ Language/Section15/Challenge"
...
Objects0=$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix) $(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix) $(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/Account.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix): Account_Util.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "H:/C++ Language/Section15/Challenge/Account_Util.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix): Checking_Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "H:/C++ Language/Section15/Challenge/Checking_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix): Savings_Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "H:/C++ Language/Section15/Challenge/Savings_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "H:/C++ Language/Section15/Challenge/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "H:/C++ Language/Section15/Challenge/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
